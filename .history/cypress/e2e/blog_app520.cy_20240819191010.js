describe('user can like blog', function (){
    ...
    describe('When logged in', function() {
        beforeEach(function() {
            // Log in the user
            cy.get('#username').type('umair42')
            cy.get('#password').type('123456789')
            cy.get('#login-btn').click()
            // Verify login succeeded
            cy.contains('umair42 logged-in', { timeout: 30000 })
          ...
          it('User can like a blog', function() {
            cy.contains('New Umair Title Test Author Umair').contains('have.text', 'view').click()
            ...
            cy.contains('Test Blog Title Test Author Umair')
              .parent()
